function [X,Proposal] =ISEM_astro(X,Proposal,Proposal0,df,Target_function,gama,j,data) % One iteration of EM with IS
...
%     end
    ...
    [X.logPrior,X.logLike]=feval(Target_function,X.Values,data);%Target_pdf_rastrigin(X.Values);%feval(Target_function,X.Values,data);
